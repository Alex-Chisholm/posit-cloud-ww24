...
## Who uses Posit Cloud?  {.full-brackets-light}
...
%%| echo: false 
flowchart LR
  A(Data Science) --> B(Consulting\nGroups)
  A(Data Science)  --> C(SMBs)
...
## People ❤️ Posit Cloud ... {.full-brackets-light}
...
* 7 in 10 (67%) would be Very Disapointed if they could no longer use Posit Cloud.
* 50% don't know another product that can solve their problems like Posit Cloud. Of those with comparisons, 66% think Posit Cloud is better.
:::

::: {.callout-tip}
## Kamil Kaźmierski | Adam Mickiewicz University in Poznań, Associate Professor
It is the workhorse of several courses I teach. It <span style="color:green;">strips away the hassle of installing software and sharing data sets and assignments</span>, and has the added benefit of enabling me to peek into my student's projects if they need help.
:::
...
![Spaces](media/spaces.png)

## Preparing to teach STAT250
...
* Sharing (visibility)
* Assingments / Templates
* Lists

## Adding students in students
...
* Seeing the content list.... [it is now theirs]

## Supporting Organizations - Without Sales Intervention
<!-- dot uses graphviz, not mermaid --> 
```{dot}
graph G {
  layout=neato
  Institution -- "Instructor A";
  Institution --  "Instructor B";
  Institution --  "Instructor C";
  "Instructor A" -- "STAT 250";
  "Instructor A" -- "STAT 350";
  "Instructor B" -- "ECON 201";
  "Instructor B" -- "ECON 202";
  "Instructor C" -- "BIO 103";
  "Instructor C" -- "BIO 104"
}
